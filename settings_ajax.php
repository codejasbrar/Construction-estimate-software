...
if(isset($_POST["action"]) && $_POST["action"]=="save")  
 { 
	...
	{
		$qt_insert="UPDATE `items` SET `category`='$category'
	WHERE id='$id'";
 mysqli_query($con,$qt_insert);
	}
	if(isset($_POST['type']) && $_POST['type']=='subcategory')
	{
		$subcategory=$_POST['subcategory'];
		$qt_insert="UPDATE `items_subcategory` SET `category`='$category', `subcategory`='$subcategory'
	WHERE id='$id'";
 mysqli_query($con,$qt_insert);
	}
}
...
if(isset($_POST["action"]) && $_POST["action"]=="delete")  
 ...
 mysqli_query($con,$qt_insert);
	...
	{
		$qt_insert="DELETE FROM `items_subcategory`
	WHERE id='$id'";
 mysqli_query($con,$qt_insert);
	}
